...
Finally, we keep a [CHANGELOG](https://github.com/vinjatovix/aft-actors-script/releases) to make it easier for users and contributors to see precisely what notable changes have been made between each release (or version) of the project.
